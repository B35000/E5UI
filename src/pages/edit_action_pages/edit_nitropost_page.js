...
class EditNitroPage extends Component {
    
    state = {
        selected: 0 , id: makeid(8), type:this.props.app_state.loc['3030']/* 'edit-nitro' */, e5:this.props.app_state.selected_e5,
        ...
        entered_pdf_objects:[], markdown:'', entered_node_url_text:'', node_url:'', album_art:null, entered_node_key_text:'', encrypted_key:''
