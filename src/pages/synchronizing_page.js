...
class synchronizing_page extends Component {
    ...
    render_synch_bar(){
        ...
        return(
            <div style={{ height: height, width: "100%", 'background-color': 'white', 'border-radius': '5px', 'box-shadow': '0px 0px 2px 1px #CECDCD', 'margin': '0px 0px 4px 0px' }}>
                <div className="progress" style={{ height: height, width: progress, 'background-color': 'black', 'border-radius': '5px' }}>
                    <div className="progress-bar" role="progressbar" style={{ width: "100%", 'background-image': 'none','background-color': 'black', 'border-radius': '3px' }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </div>
        )
    }
    ...
    render_bottom_text(){
        return(
            <div>
                <Row>
                    <Col><p style={{margin: '25% 0% 0% 0%', width:'70%'}}>Peer to Peer Trust</p></Col>
                    <Col>
                        <img style={{width:'130%', margin:'5% 0% 0% 17%'}} src={p2p_trust} alt="Paris"/>
                    </Col>
                </Row>
                <Row style={{margin: '25% 0% 0% 0%'}}>
                    <Col><p style={{margin: '25% 0% 0% 0%'}}>Unanimous Consensus</p></Col>
                    <Col>
