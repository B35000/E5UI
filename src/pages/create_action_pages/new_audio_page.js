...
class NewAudioPage extends Component {
    ...
    get_new_job_page_tags_object(){
        var obj = {
            ...
            'e':[
                ['or','',0], ['e', this.props.app_state.loc['a311bg']/* 'metadata' */,this.props.app_state.loc['110'], this.props.app_state.loc['112'], this.props.app_state.loc['298'], this.props.app_state.loc['a311b']/* 'album-fee' */, this.props.app_state.loc['a311c']/* 'track-list' */], [0]
            ],
            'text':[
    ...
    when_add_song_tapped(){
        ...
        if(song_title == ''){
            ...
            var song = {'song_id':makeid(8), 'song_title':song_title, 'song_composer':song_composer, 'price_data':price_data2, 'track':audio_file, 'songs_free_plays_count':songs_free_plays_count, 'basic_data':this.get_song_basic_data(audio_file)}
            ...
            this.setState({songs: clone, song_title:'', song_composer:'', price_data2:[], edit_song_item_pos: -1, audio_file:null})
    ...
    focus_tab(item_pos){
        if(this.is_tab_active(item_pos)){
            this.setState({song_title:'', song_composer:'', price_data2:[], edit_song_item_pos: -1, audio_file:null})
        }else{
    ...
    set_focused_song_data(item_pos){
        ...
        this.setState({song_title: song['song_title'], song_composer: song['song_composer'], price_data2: song['price_data'], audio_file: song['track'], edit_song_item_pos: item_pos, songs_free_plays_count: song['songs_free_plays_count']});
    }
