...
class NewMailPage extends Component {
    ...
    render_title_tags_part(){
        return(
            <div style={{'padding':'0px 10px 0px 10px'}}>
                {this.render_detail_item('4',{'font':'Sans-serif', 'textsize':'15px','text':this.props.app_state.loc['286']})}
                <div style={{height:10}}/>
                <TextInput height={60} placeholder={this.props.app_state.loc['123']} when_text_input_field_changed={this.when_title_text_input_field_changed.bind(this)} text={this.state.entered_title_text} theme={this.props.theme}/>
                <div style={{height: 10}}/>
                ...
                {this.render_detail_item('4',{'font':'Sans-serif', 'textsize':'14px','text':this.props.app_state.loc['287']})}
                <div style={{height:10}}/>
                <TextInput height={30} placeholder={this.props.app_state.loc['288']} when_text_input_field_changed={this.when_target_recipient_input_field_changed.bind(this)} text={this.state.target_recipient} theme={this.props.theme}/>
                {this.load_account_suggestions()}
                <div style={{height:10}}/>

                <div style={{height:'1px', 'background-color':'#C1C1C1', 'margin': '0px 20px 20px 20px'}}/>
                {this.render_detail_item('4',{'font':'Sans-serif', 'textsize':'15px','text':this.props.app_state.loc['289']})}
                <div style={{height:10}}/>
    ...
    render_text_part(){
        ...
        return(
            <div style={{'margin':'10px 0px 0px 10px'}}>
                {this.render_detail_item('4',{'font':'Sans-serif', 'textsize':'15px','text':this.props.app_state.loc['290']})}
                {this.render_detail_item('0')}
    ...
    render_enter_links_part(){
        return(
            <div style={{'margin':'10px 0px 0px 0px'}}>
                {this.render_detail_item('4',{'font':'Sans-serif', 'textsize':'15px','text':this.props.app_state.loc['291']})}
                <div style={{height:10}}/>
    ...
    when_searched_link_tapped(item){
        ...
        if(pos > -1){
            this.props.notify(this.props.app_state.loc['293'], 1700)
        }else{
            clone.push(item)
            this.setState({added_links: clone})
            this.props.notify(this.props.app_state.loc['294'], 1400)
        }
    }
