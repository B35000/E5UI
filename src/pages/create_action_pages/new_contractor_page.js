    ...
    finish_creating_object(){
        ...
        if(index_tags.length < 3){
            ...
            setTimeout(function() {
                ...
                me.setState({ id: makeid(8), type:'contractor', get_new_contractor_page_tags_object: me.get_new_contractor_page_tags_object(), get_new_contractor_text_tags_object: me.get_new_contractor_text_tags_object(), entered_tag_text: '', entered_title_text:'', entered_text:'', entered_indexing_tags:[], entered_text_objects:[], entered_image_objects:[], entered_objects:[], exchange_id:'', price_amount:0, price_data:[], })
            }, (1 * 1000));
