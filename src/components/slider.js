    ...
    render(){
        return(
            <div style={{'display': 'flex','flex-direction': 'row','margin': '20px 0px 0px 0px'}}>
                ...
                <div style={{ height: 30, width: 220, 'border-radius': '17px', 'box-shadow': '0px 0px 1px 1px #CECDCD', 'margin': '0px 0px 0px 10px' , 'position': 'relative'}}>

                    <div className="progress" style={{ height: 30, width: 250, 'background-color': '#999999' , 'z-index':'1' , 'border-radius': '17px', 'position': 'absolute'}}>
                    ...
                    <input type="range" value={this.props.value} min="0" max="999" className="form-range" onChange={this.handleNumber} style={{opacity: 0, width: 250, height: 40, 'position': 'absolute', 'z-index':'10'}}/>
