    ...
    render_text_input_field(height){
      return(
        <div style={{'padding': '0px 0px 0px 0px'}}>
            <div style={{'display': 'flex', 'background-color': this.props.theme['secondary_text_color'],'flex-direction': 'row','margin': '0px 0px 0px 0px','border-radius': '0px 10px 10px 0px'}}>
